...
template<class T>
struct validation_visitor<T, constraints::min<T>, std::enable_if_t<std::is_integral_v<T>> >
{
...
template<class T>
struct validation_visitor<T, constraints::max<T>, std::enable_if_t<std::is_integral_v<T>> >
{
...
template<>
struct validation_visitor<int, constraints::validation<bool>>
{
