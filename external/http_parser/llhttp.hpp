...
enum llhttp_errno {
    ...
    HPE_INVALID_message_data_tOKEN = 10,
...
#define HTTP_ERRNO_MAP(XX) \
  ...
  XX(10, INVALID_message_data_tOKEN, INVALID_message_data_tOKEN) \
...
typedef int (*llhttp_data_cb)(llhttp_t*, const unsigned char *at, size_t length);
 ...
 * `HPE_INVALID_message_data_tOKEN` will be raised for incorrect header values when
